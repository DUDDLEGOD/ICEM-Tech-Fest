...
export const SiteAnnouncement: React.FC = () => {
  ...
  return (
    <section id="site-notice" className="px-4 md:px-6 pt-4">
      <div className="max-w-7xl mx-auto rounded-[2rem] border border-cyan-400/20 bg-gradient-to-r from-cyan-400/10 via-purple-400/5 to-transparent px-5 py-4 md:px-8 md:py-5 shadow-[0_25px_60px_rgba(0,0,0,0.25)]">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          {announcement.ctaText.trim() && announcement.ctaHref.trim() && (
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-2xl border border-cyan-300/30 px-5 py-3 text-[11px] font-black uppercase tracking-[0.25em] text-cyan-200 transition-colors hover:bg-gradient-to-r hover:from-[#06b6d4] hover:to-purple-400 hover:text-slate-950"
            >
