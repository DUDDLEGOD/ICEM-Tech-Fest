...
import { 
  BookOpen, Target, Users, Landmark, Zap, ChevronLeft, 
  Award, Globe, Shield, Cpu, Library, Rocket, 
  Code, Radio, Microscope, Activity
} from 'lucide-react';
...
const HUDDecoration = ({ className }: { className?: string }) => (
  <div className={`absolute pointer-events-none opacity-[0.03] font-futuristic text-[8px] uppercase tracking-[0.4em] text-white space-y-2 ${className}`}>
    <div className="flex items-center gap-2"><Radio size={10} /> SYSTEM_STATUS: OPERATIONAL</div>
    <div className="flex items-center gap-2"><Cpu size={10} /> NETWORK_LATENCY: 12MS</div>
    <div className="flex items-center gap-2"><Shield size={10} /> PROTOCOL: HTTPS_SECURE</div>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="space-y-24">
          {/* Section 1: TechnoFest Event Intel */}
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            <div className="lg:col-span-3 space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-amber-500/10 border border-amber-500/20 rounded-full text-amber-500 text-[10px] font-black uppercase tracking-widest leading-none">
                  <Activity size={12} /> Live Event Briefing
                </div>
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-futuristic font-black uppercase italic leading-[1] tracking-tighter text-white">
                  THE FESTIVAL OF <br/>
                  <span className="text-amber-500">FUTURE TECHNOLOGY</span>
                </h1>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="glass p-6 rounded-2xl border-white/5 space-y-3 hover:bg-white/[0.02] transition-all">
                    ...
                    <p className="text-[11px] text-slate-500 font-bold leading-relaxed uppercase">Adhering to professional industry standards in hackathons and robotics.</p>
                  </div>
                  <div className="glass p-6 rounded-2xl border-white/5 space-y-3 hover:bg-white/[0.02] transition-all">
                    ...
                    <p className="text-[11px] text-slate-500 font-bold leading-relaxed uppercase">Direct engagement between students and corporate technical leadership.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 relative group mt-8 lg:mt-0">
              <div className="absolute -inset-4 bg-amber-500/5 blur-2xl rounded-[2.5rem] group-hover:bg-amber-500/10 transition-all duration-700"></div>
              <div className="relative glass border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
                <img 
                  src="https://images.shiksha.com/mediadata/images/1552471453phpAHMSjf.jpeg" 
          ...
          {/* Section 2: ICEM Institution - The Blueprint */}
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-start">
                  ...
                  <div className="group glass p-6 rounded-2xl border-white/5 hover:border-blue-500/30 transition-all bg-gradient-to-br from-blue-500/[0.02] to-transparent">
                    <div className="flex gap-5 items-start">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-slate-400 leading-relaxed font-medium">Global leaders in technology through comprehensive academic research.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group glass p-6 rounded-2xl border-white/5 hover:border-amber-500/30 transition-all bg-gradient-to-br from-amber-500/[0.02] to-transparent">
                    <div className="flex gap-5 items-start">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[11px] text-slate-400 leading-relaxed font-medium">Equipping students with professional skillsets for technical innovation.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="glass p-6 rounded-2xl border-white/5 hover:bg-white/[0.02] transition-colors group">
                ...
                <div className="md:col-span-2 glass p-6 rounded-3xl border-white/5 relative overflow-hidden h-[240px]">
                  <img 
                    src="https://images.shiksha.com/mediadata/images/1571490951phpBvvHa3.jpeg" 
                  ...
                  <div className="relative z-10 flex flex-col justify-end h-full">
                    ...
                    <p className="text-[9px] text-amber-500 font-black uppercase tracking-[0.4em] mt-1">Parandwadi / Pune / MH</p>
                    <a 
          ...
          <div className="pt-20 border-t border-white/5 relative">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1px] h-16 bg-gradient-to-b from-amber-500 to-transparent"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={i} className="space-y-1 group">
                  ...
                  <span className="text-[7px] font-black text-white/10 uppercase tracking-[0.4em] block">
                    {stat.sub}
                  </span>
                </div>
              ))}
